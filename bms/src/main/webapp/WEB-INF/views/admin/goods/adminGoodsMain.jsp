			 	...
			 	<c:otherwise>
     				<c:forEach var="item" items="${newGoodsList}">
						<tr>       
							...
							<td><input type="button" id="deleteGoods" class="btn btn-primary btn-sm" value="${item.goodsId}" /></td>
							<td><a href="${contextPath}/admin/goods/deleteGoods.do?goodsId=${item.goodsId}">삭제</a></td>
						</tr>
					</c:forEach>
				</c:otherwise>
  			</c:choose>	        
