...
<script>
	...
	function validateNewMember(){
		if($('#memberId').val()==''){
			...
			$('#hp3').focus();
			return false;
		}else if($('#smsstsYn').val()==''){
			alert('이메일 수신동의 여부를 확인해주세요!');
			$('#smsstsYn').focus();
			return false;
...
<body>
	<form action="${contextPath}/member/addMember.do" method="post" onsubmit="return validateNewMember()">
		<h3>회원가입</h3>
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" class="form-control"
					...
					type="button" id="btnOverlapped" class="btn btn-primary btn-sm"
					value="중복확인" /></td>
			</tr>
			<tr>
				<td><label class="small mb-1" for="memberPw">비밀번호</label></td>
				<td><input class="form-control" id="memberPw" name="memberPw"
			...
			<tr>
				...
				<td><input class="custom-control-input" type="radio" id="g1"
					name="memberGender" value="101" checked /> <label
			...
			<tr>
				...
				</select> - <input class="form-control" size="10px" type="text" name="tel2"
					style="display: inline; width: 100px; padding: 0"> - <input
					class="form-control" size="10px" type="text" name="tel3"
			...
			<tr>
				...
				</select> - <input class="form-control" size="10px" type="text" name="hp2"
					style="display: inline; width: 100px; padding: 0"> - <input
					class="form-control" size="10px" type="text" name="hp3"
			...
			<tr>
				...
				<br> <input class="custom-control-input" id="emailstsYn"
					type="checkbox" name="emailstsYn" value="Y" checked /> <label
					for="emailstsYn">BMS에서 발송하는 E-mail을 수신합니다.</label></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">이미 회원가입이 되어있다면 ? <a
					href="${contextPath}/member/loginForm.do"><strong>로그인하기</strong></a>
				</td>
			</tr>
		</table>
	</form>
